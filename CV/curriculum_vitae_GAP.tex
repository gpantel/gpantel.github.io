...
\begin{sousrubrique}
\Titre{``Parameterization of a sequence-specific coarse-grained collagen model,'' \textit{Biophysical Society Annual Meeting (Poster)}}
\Date{2023}
\end{sousrubrique}

\begin{sousrubrique}
\Titre{``Simulating Atomistic Structure of Collagen: Force Field Corrections and Beyond,'' \textit{Protein Folding Dynamics Gordon Research Conference (Poster)}}
\Date{2022}
\end{sousrubrique}

\begin{sousrubrique}
\Titre{``Atomistic Structure of Collagen: Validation of Atomistic Force Fields,'' \textit{Boston University Physical Chemistry Lecture Series (Talk)}}
\Date{2022}
\end{sousrubrique}
