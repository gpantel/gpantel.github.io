...
\begin{sousrubrique}
\Titre{``Exploring phase separation and domain formation in lipid bilayers through molecular simulation,'' \textit{Boston University Graduate Research Symposium; ACS 252nd National Meeting (Poster)}}
\Date{2016}
\end{sousrubrique}

\begin{sousrubrique}
\Titre{``Examining the conformational dynamics of the N-terminal region of mdm2 using markov state model approaches,'' \textit{ACS 250th National Meeting (Poster)}}
\Date{2015}
\end{sousrubrique}
